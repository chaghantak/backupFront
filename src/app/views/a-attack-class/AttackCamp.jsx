...
import CountryDiv from "./AttackClassCountryDiv";


import "../attackStyle.css";

function AttackClassCountry(props) {
    const groupData = [
        {
            "id" : "G0016",
            "name" : "APT29",
        ...
        return(
         ...
         {groupData.map((groupData, index) => (
                <>
            <CountryDiv groupData={groupData} index={index}/>
                </>
           ))}
...
export default AttackClassCountry;